...
public class ExcelBinaryReaderTest : ExcelTestBase
{
    ...
    [Test]
    public void GetCellFormula_BIFF3_SpacesExcel3()
    {
        // Excel 3.0 supports spaces only in macro sheets,
        // and only following the equality sign.
        VerifyFormulas(Path.Combine("xls", "BIFF3", "SPACES.xlm"), Path.Combine("xls", "BIFF3", "SPACES.txt"));
    }
    ...
    [Test]
    public void GetCellFormula_BIFF4_SpacesExcel4()
    {
        // Excel 4.0 supports spaces and carriage returns
        // in more scenarios.
        VerifyFormulas(Path.Combine("xls", "BIFF4", "SPACES.xlm"), Path.Combine("xls", "BIFF4", "SPACES.txt"));
    }
